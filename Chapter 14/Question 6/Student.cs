...
namespace Question_6
{
    public class Student
    {
        ...
        private Student(string fullNames, string course, University universities, string email, string phoneNumber, params Subject[] subjects)
            {
        ...
        internal Student (University universities, string course)
        {
            this.course = course;
            this.universities = universities;
            studentCount++;
        ...
        internal Student (string fullNames, params Subject[] subjects)
        {
            this.fullNames = fullNames;
            this.subjects = subjects;
            studentCount++;
        ...
        {
            return $"{this.FullNames}   {this.Age}  {this.Course}   " +
             $"{this.Email} {ListOfSubjects(Subjects)}  {this.Universities.ToString()}";
        }
        
        string mySubjects = string.Empty;
        public string ListOfSubjects( Subject[] subjects)
        {
           if(subjects != null)
           {
